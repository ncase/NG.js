...
NG.loadScores = function(score_page,number_of_results,time_period){
	// Secure post
    return _securePost("loadScores",{
    	publisher_id: 1,
    	board: NG.connection["score_boards"][0]["id"],
    	page: score_page,
...
NG.postScore = function(scoreAmount){
	// Secure post
